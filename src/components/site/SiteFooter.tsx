...
export function SiteFooter() {
  return (
    <footer className="mt-12 bg-brand-navy text-primary-foreground">
      ...
      <div className="mx-auto grid max-w-[1200px] gap-8 px-5 py-10 md:grid-cols-3">
        <div>
          ...
          <div className="mt-4 flex gap-3">
            <a href="https://www.facebook.com/share/1HhoEwofu7/" target="_blank" rel="noreferrer" aria-label="Facebook" className="rounded-full bg-primary-foreground/10 p-2 transition-colors hover:bg-brand-red">
              <Facebook className="h-4 w-4" />
            </a>
            <a href="https://www.instagram.com/gtu_itr_official" target="_blank" rel="noreferrer" aria-label="Instagram" className="rounded-full bg-primary-foreground/10 p-2 transition-colors hover:bg-brand-red">
              <Instagram className="h-4 w-4" />
            </a>
            <a href="https://www.linkedin.com/in/gtu-institute-of-technology-and-research-gtu-itr-927170258" target="_blank" rel="noreferrer" aria-label="LinkedIn" className="rounded-full bg-primary-foreground/10 p-2 transition-colors hover:bg-brand-red">
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm text-primary-foreground/80">
            {QUICK.map((q) => (
              <li key={q.to}>
                <Link to={q.to} className="transition-colors hover:text-brand-gold">
                  {q.label}
                </Link>
              </li>
            ))}

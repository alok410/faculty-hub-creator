...
export const Route = createFileRoute("/media-coverage")({
  ...
  head: () => ({
    meta: [
      ...
      { name: "description", content: "GTU-ITR social media presence — YouTube, LinkedIn, Facebook & Instagram." },
      { property: "og:title", content: "Media Coverage | GTU-ITR" },
      { property: "og:description", content: "GTU-ITR social media presence — YouTube, LinkedIn, Facebook & Instagram." },

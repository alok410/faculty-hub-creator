...
export const Route = createFileRoute("/academics/diploma/mechanical")({
  head: () => ({
    meta: [
      { title: "Mechanical Engineering (Diploma) | GTU-ITR" },
      { name: "description", content: "Design, manufacturing, thermal and automotive systems." },
      { property: "og:title", content: "Mechanical Engineering (Diploma) | GTU-ITR" },
    ...
    <PageShell title="Mechanical Engineering (Diploma)" subtitle="Design, manufacturing, thermal and automotive systems.">
      <Prose>
        ...
        <section>
          ...
          <div className="mt-2 mb-3 h-1 w-14 bg-brand-red" />
          <p>Graduates of the diploma programme in Mechanical Engineering find opportunities in core industry, public sector undertakings, consultancy, government services, research organisations and higher studies. The institute's Training &amp; Placement Cell supports students throughout this journey.</p>
        </section>
      </Prose>
    </PageShell>
  );

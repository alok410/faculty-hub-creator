...
export const Route = createFileRoute("/academics/diploma/computer")({
  head: () => ({
    meta: [
      { title: "Computer Engineering (Diploma) | GTU-ITR" },
      { name: "description", content: "Software, systems, networks and intelligent computing." },
      { property: "og:title", content: "Computer Engineering (Diploma) | GTU-ITR" },
    ...
    <PageShell title="Computer Engineering (Diploma)" subtitle="Software, systems, networks and intelligent computing.">
      <Prose>
        ...
        <section>
          ...
          <div className="mt-2 mb-3 h-1 w-14 bg-brand-red" />
          <p>Graduates of the diploma programme in Computer Engineering find opportunities in core industry, public sector undertakings, consultancy, government services, research organisations and higher studies. The institute's Training &amp; Placement Cell supports students throughout this journey.</p>
        </section>
      </Prose>
    </PageShell>
  );
